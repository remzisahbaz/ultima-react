...
const App = () => {
    ...
    const menu = [
        {
             label: 'CUSTOMER MANAGMENT', icon: 'pi pi-fw pi-home',
            items: [
                { label: 'Companies', icon: 'pi pi-fw pi-home', to: '/', badge: '+99', badgeClassName: 'p-badge-info' },
            ]
        },
        {
         ...
         {
             label: "CV MANAGMENT", icon: "pi pi-fw pi-prime",
        //     items: [
        ...
        {
            label: 'PROJECT MANAGMENT', icon: 'pi pi-fw pi-briefcase',
            // items: [
