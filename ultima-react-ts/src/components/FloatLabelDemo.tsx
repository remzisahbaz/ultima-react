...
const FloatLabelDemo = () => {
    ...
    const [value10, setValue10] = useState<any>(null);
    ...
    return (
        <div className="card">
            ...
            <div className="grid p-fluid mt-3">
                ...
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <Calendar id="calendar" value={value7} onChange={(e) => setValue7(e.value)}></Calendar>
                        <label htmlFor="calendar">Calendar</label>
                    </span>
                </div>
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <Chips id="chips" value={value9} onChange={(e) => setValue9(e.value)}></Chips>
